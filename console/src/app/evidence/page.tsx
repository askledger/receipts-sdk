...
const PACKS = [
  { id: "evp-2026-q2-cbuae", title: "Q2 2026 · CBUAE Inspection Pack", count: 138_247, builtBy: "rashed.khan@acme-bank", builtAt: "2026-06-05 14:22", status: "allow" as const, label: "delivered" },
  ...
  { id: "evp-2026-q3-sama", title: "Q3 2026 · SAMA submission (draft)", count: 87_154, builtBy: "rashed.khan@acme-bank", builtAt: "2026-06-09 17:50", status: "pending" as const, label: "review" },
];
