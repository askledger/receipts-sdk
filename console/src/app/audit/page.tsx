...
const AUDIT = [
  { at: "2026-06-10 17:31", actor: "jordan.lee@acme-bank", action: "key.rotate", target: "kms-prod-2026Q3", status: "allow", hash: "f01a2b3c4d5e6f70...a9b8c7" },
  ...
  { at: "2026-06-10 14:58", actor: "jordan.lee@acme-bank", action: "policy.publish", target: "platform/api/v1/authz@2026.06.04", status: "allow", hash: "13d4e5f607182930...4b5c6d" },
