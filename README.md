...
[![Tests](https://img.shields.io/badge/tests-481%20passing-brightgreen)](#testing)
...
|---|---|---|---|
| `@askledger/receipts-sdk` | TypeScript / Node 18+ / browsers | live on npm · 485 tests (481 pass, 4 HSM-live skipped) | Reference |
...
| **Tests** | |
| 481 TypeScript tests | ✅ Passing (4 HSM-live skipped without hardware) |
